DROP DATABASE IF EXISTS universidad_prueba;
CREATE DATABASE universidad_prueba CHARACTER SET utf8mb4;
...
CREATE TABLE persona (
    ...
    CONSTRAINT id_per_pk PRIMARY KEY (id),
    CONSTRAINT nif_unique UNIQUE(nif)   
);

CREATE TABLE profesor (
    id_profesor INT UNSIGNED,
    id_departamento INT UNSIGNED NOT NULL,
    CONSTRAINT id_pro_pk PRIMARY KEY (id_profesor),
    CONSTRAINT id_prof_fk FOREIGN KEY (id_profesor) REFERENCES persona(id),
    CONSTRAINT id_depart_fk FOREIGN KEY (id_departamento) REFERENCES departamento(id)
);

 CREATE TABLE grado (
    id INT UNSIGNED AUTO_INCREMENT,
    nombre VARCHAR(100) NOT NULL,
    CONSTRAINT id_grado_pk PRIMARY KEY (id)
);
...
CREATE TABLE asignatura (
    ...
    CONSTRAINT id_asig_pk PRIMARY KEY (id),
    CONSTRAINT id_prof_asig_fk FOREIGN KEY(id_profesor) REFERENCES profesor(id_profesor),
    CONSTRAINT id_grado_asig_fk FOREIGN KEY(id_grado) REFERENCES grado(id)
);
...
CREATE TABLE curso_escolar (
    ...
    CONSTRAINT id_cEsc_pk PRIMARY KEY (id)
);
...
CREATE TABLE alumno_se_matricula_asignatura (
    ...
    CONSTRAINT id_alu_asig_cEsc_pk PRIMARY KEY (id_alumno, id_asignatura, id_curso_escolar),
    CONSTRAINT id_alumno_fk FOREIGN KEY (id_alumno) REFERENCES persona(id),
    CONSTRAINT id_asig_fk FOREIGN KEY (id_asignatura) REFERENCES asignatura(id),
    CONSTRAINT id_c_esc_fk FOREIGN KEY (id_curso_escolar) REFERENCES curso_escolar(id)
);
